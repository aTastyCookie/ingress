...
python bin/create_gmail_accV3.py $MAIL $PASS $PX
#./bin/afterauth2.sh $MAIL $PASS
#done
if [ "$2" -eq "1" ]; then
TYPE="gen";
echo $TYPE;
...
#  echo found code $CODE
  ...
  if [ $3 -eq "1" ]; then
    ...
    ./bin/intelauth3.sh                                                                                                                                                                      
    ./bin/intelauth4.sh         
    scp cookiemap.txt root@185.66.70.13:/opt/intelbot/intel/cookies/$NAME.cookie.txt
    scp csrftokenmap.txt root@185.66.70.13:/opt/intelbot/intel/cookies/$NAME.csrftoken.txt
