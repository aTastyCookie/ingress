...
echo $1 | grep -E -q 'ULTRA_STRIKE|CAPSULE|EMITTER_A|EMP_BURSTER|PORTAL_LINK_KEY|FLIP_CARD|MEDIA|POWER_CUBE|RES_SHIELD|LINK_AMPLIFIER|HEATSINK|FORCE_AMP|MULTIHACK|TURRET' \
